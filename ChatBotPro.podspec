#
#  Be sure to run `pod spec lint ChatBotPro.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ranapn123"
  # s.authors            = { "ranapn123" => "ranapnm@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ranapn123"
